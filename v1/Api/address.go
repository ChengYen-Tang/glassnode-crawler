...
func SetAddressApi(apiInfos *list.List, rootFolder *string) {
	...
	for _, symbol := range symbols {
		...
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/sending_to_exchanges_count?a=%s&i=10m&f=CSV", &folder, &symbol))
		...
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/receiving_count?a=%s&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/sending_count?a=%s&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_less_0001?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_more_100k?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_0001_001?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_001_01?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_01_1?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_1_10?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_10_100?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_100_1k?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_10k_100k?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/supply_balance_1k_10k?a=%s&c=USD&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/count?a=%s&i=10m&f=CSV", &folder, &symbol))
		apiInfos.PushBack(modules.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/addresses/receiving_from_exchanges_count?a=%s&i=10m&f=CSV", &folder, &symbol))
	}
}
