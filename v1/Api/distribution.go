...
func SetDistributionApi(tc *modules.TaskController, rootFolder *string) {
	...
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_grayscale_trust?a=BTC&f=CSV", &folder, true)
	...
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_luna_foundation_guard?a=BTC&i=1h&f=CSV", &folder, true)
	for _, miner := range btcMiners {
		tc.GetAPIInfoTag("https://api.glassnode.com/v1/metrics/distribution/balance_miners_sum?a=BTC&miner=%s&i=24h&f=CSV", &folder, &miner, false)
	}
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_miners_all?a=BTC&i=24h&f=CSV", &folder, true)
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_miners_change?a=BTC&i=24h&f=CSV", &folder, false)
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_mtgox_trustee?a=BTC&i=1h&f=CSV", &folder, true)
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/outflows_mtgox_trustee?a=BTC&i=24h&f=CSV", &folder, true)
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_otc_desks?a=BTC&i=1h&f=CSV", &folder, true)
	...
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_us_government?a=BTC&i=1h&f=CSV", &folder, true)
	tc.GetAPIInfoDefault("https://api.glassnode.com/v1/metrics/distribution/balance_wbtc?a=BTC&i=1h&f=CSV", &folder, true)
}
